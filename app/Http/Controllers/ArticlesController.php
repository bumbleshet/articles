...
class ArticlesController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $category_index = $article->category_id;

        $categories = Category::all();
        return view('articles.show', compact('article'))->with('categories', $categories)
                ->with('category_index', $category_index );
    }
    ...
    public function update($id)
    {
        ...
        return redirect('articles')->with('categories', $categories);
